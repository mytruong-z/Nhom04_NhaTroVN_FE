                        ...
                        <div className="col-11">
                            <div className="row ">
                                ...
                                <div className="col-lg-4 col-12">
                                    ...
                                    <ul className="list-unstyled">
                                        <li className="pb-1"><a href="/" className="text-decoration-none text-white">Trang Chủ</a></li>
                                        <li className="pb-1"><a href="/login" className="text-decoration-none text-white">Đăng Nhập</a></li>
                                        <li className="pb-1"><a href="/register" className="text-decoration-none text-white">Đăng ký</a></li>
                                    </ul>
                                </div>
                                <div className="col-lg-4 col-12">
                            ...
                            <div className="row ">
                                <div
                                    ...
                                    <small className="rights"><span>&#174;</span> HCMUS Students All Rights Reserved.</small>
                                </div>
                                <div className="col-lg-4 col-12 order-1 align-self-end ">
                                    <h6 className="mt-55 mt-2 text-muted bold-text"><b>HỖ TRỢ</b></h6><small>
                                    <span><AiOutlineMail/></span> contact@student.hcmus.edu.vn</small>
                                </div>
                                <div className="col-lg-4 col-12 order-2 align-self-end mt-3 ">
                                    <h6 className="text-muted bold-text"><b>HOTLINE</b></h6><small>
                                    <span><AiFillPhone/></span> +89 123 4567 321</small>
                                </div>
                            </div>
                        </div>
                    </div>
