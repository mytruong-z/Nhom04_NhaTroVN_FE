        ...
        <div>
            <div class="lasagna">
                ...
                <div class="plan">
                    <h3>Gói Đồng</h3>
                    <p>$199.000 vnd</p>
                    <Button className="mt-3 mb-3 btn btn-default text-white " onClick={() => { payment(2); }}>Mua</Button>
                    &nbsp;
                    <div class="includes">
                        Includes
                        <ul>
                ...
                <div class="plan">
                    ...
                    <p>$399.000 vnd</p>
                    <p></p>
                    <Button className="mt-3 mb-3 btn btn-default text-white " onClick={() => { payment(3); }}>Mua</Button>
                    &nbsp;
                    <div class="includes">
                        includes
                        <ul>
                ...
                <div class="plan">
                    <h3>Gói Vàng</h3>
                    <p>$599.000 vnd</p>
                    <Button className="mt-3 mb-3 btn btn-default text-white " onClick={() => { payment(4); }}>Mua</Button>
                    &nbsp;
                    <div class="includes">
                        includes
                        <ul>
